...
import {FlatList, ListView, RefreshControl, ScrollView, StyleSheet, View} from "react-native";
...
class VozThreadPage extends Component {
    ...
    _onRefresh() {
        ...
        this.setState({isRefreshing: true, loading: true, currentPage: 1});
        this.props.actions.getThreadList(forumId, 1);
    }
    ...
    render = () => {
        ...
        const {isRefreshing, currentPage} = this.state;
                        ...
                        <FlatList
                            ...
                            renderItem={({item}) => (
                                <ListItem
                                    ...
                                    onPress={() => Actions.vozPost({
                                        threadId: parseInt(item.id),
